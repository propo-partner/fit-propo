...
export default function Header () {
  ...
  const drwFunc = () => {
	...
	// const [arrFlag, setArrFlag] = useState([true, false, false, false, false ])
							...
							<div className={`${styles.drwNav__wrap__menu} ${styles.wide}`}>
								...
								<div className={styles.menuList}>
									<ul className={styles.menuList_category}>
										<li className={`${styles.menuList_categoryItem} ${styles.active} ${styles.cat_tab01}`} onClick={changeTabMenu} id={styles.cat_podcasting}>
										...
										<li className={`${styles.menuList_categoryItem}  ${styles.cat_tab02}`} onClick={changeTabMenu} id={styles.cat_hotepisodes}>
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.72 107.72">
												<path 
										...
										<li className={`${styles.menuList_categoryItem}  ${styles.cat_tab03}`} id={styles.cat_usecase}>
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.72 107.72">
												<path 
										...
										<li className={`${styles.menuList_categoryItem}  ${styles.cat_tab04}`} onClick={changeTabMenu} id={styles.cat_news}>
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.72 107.72">
												<path 
										...
										<li className={`${styles.menuList_categoryItem}  ${styles.cat_tab05}`} onClick={changeTabMenu} id={styles.cat_interview}>
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.72 107.72">
												<path 
