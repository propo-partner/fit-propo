          ...
          <div className={`${styles.sp_nav}` }>
				...
				<nav className={`${styles.drwNav} ${openMenu ? styles.active : undefined}`}>
					<div className={`${styles.drwNav__wrap} ${styles.font_en}`}>
						...
						<div className={`${styles.drwNav__wrap__menu} ${styles.noborder}`}>
						...
						<div className={`${styles.drwNav__wrap__menu} ${styles.drw_sns}`}>
							<a className={styles.drwNav__wrap__menu__fb} href="https://www.facebook.com/propo.fm/" target="_blank" rel="noopener noreferrer">
								<svg className={styles.ico_fb} viewBox="0 0 13 13" xmlns="http://www.w3.org/2000/svg" fill="white">
							...
							<svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M12.9543 2.99324C12.9635 3.11864 12.9635 3.24407 12.9635 3.36948C12.9635 7.19448 9.98603 11.6018 4.5441 11.6018C2.86754 11.6018 1.3101 11.127 0 10.3029C0.238207 10.3298 0.467221 10.3387 0.714593 10.3387C2.09795 10.3387 3.37142 9.88188 4.38835 9.10254C3.08741 9.07565 1.99719 8.24257 1.62157 7.09596C1.80481 7.12281 1.98803 7.14074 2.18044 7.14074C2.44611 7.14074 2.71182 7.10489 2.95916 7.04222C1.60327 6.77346 0.58631 5.60894 0.58631 4.20256V4.16674C0.980239 4.38173 1.43835 4.51609 1.92387 4.53399C1.12682 4.01442 0.60464 3.1276 0.60464 2.12431C0.60464 1.58685 0.751197 1.09416 1.00773 0.664183C2.46442 2.41993 4.65402 3.56652 7.10927 3.69195C7.06347 3.47696 7.03598 3.25303 7.03598 3.02908C7.03598 1.43456 8.35524 0.135681 9.99514 0.135681C10.8472 0.135681 11.6167 0.485038 12.1572 1.04939C12.826 0.923981 13.4673 0.682106 14.0354 0.350672C13.8154 1.02253 13.3482 1.58688 12.7344 1.94517C13.3299 1.88249 13.9071 1.72121 14.4384 1.49729C14.0354 2.07057 13.5315 2.58115 12.9543 2.99324Z" fill="white"/>
</svg>
							</a>
						</div>
					</div>
