      ...
      <div className={styles.header_bgWrap}>
        <header id="header" className={`${styles.header} ${styles.row}"`}>
          ...
          <ul className={`${styles.header__nav__list} ${styles.global_nav_list}`}>
            ...
            <li className={`${styles.global_nav_list__item} ${styles.gloval_nav_dropdown}`}>
          ...
          <div id="sp_nav" className={`${styles.sp_nav} ${styles.menu} ${styles.sp_size}` }>
					<ul className={styles.sp_nav__menu}>
						<li className={`${styles.sp_nav__menu__open} ${styles.drwBtn}`}>
							<div id="sp_drw_menu" className={`${styles.drwBtn__line} ${openMenu ? styles.active : undefined}`} onClick={() => drwFunc()}>
								<div></div>
								<div></div>
							</div>
				...
				<nav id="sp_drwNav" className={`${styles.drwNav} ${styles.sp_size} ${openMenu ? styles.active : undefined}`}>
					<div id="sp_drw_nav_1" className={`${styles.drwNav__wrap} ${styles.font_en}`}>
						<a className={styles.drwNav__wrap__logo} href="https://propo.fm/"><img id="brandImg-drw"
						...
						<div className={styles.drwNav__wrap__flex}>
							...
							<div className={`${styles.drwNav__wrap__menu} ${styles.wide}`}>
								...
								<div className={styles.menuList}>
									<ul className={styles.menuList_category}>
										<li className={`${styles.menuList_categoryItem} ${styles.active}`} onClick={changeTabMenu} id={0}>
										...
										<li className={styles.menuList_categoryItem} onClick={changeTabMenu} id={1}>
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.72 107.72">
												<path className={styles.cls-1}
										...
										<li className={styles.menuList_categoryItem} onClick={changeTabMenu} id={2}>
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.72 107.72">
												<path className={styles.cls-1}
										...
										<li className={styles.menuList_categoryItem} onClick={changeTabMenu} id={3}>
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.72 107.72">
												<path className={styles.cls-1}
										...
										<li className={styles.menuList_categoryItem} onClick={changeTabMenu} id={4}>
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.72 107.72">
												<path className={styles.cls-1}
									...
									<ul className={styles.menuList_itemWrap}>
										<li className={`${styles.menuList_lv2Item} ${styles.active}`}>
                          ...
                          <div className={styles.menuList_lv3Item">
                            <div className={styles.lv3ttl"><a href="">ポッドキャストのトレンド</a></div>
										...
										<li className={styles.menuList_lv2Item}>
											<div className={styles.menuList_lv2Item__title}>
										...
										<li className={styles.menuList_lv2Item}>
											<div className={styles.menuList_lv2Item__title}>
												<div className={styles.lv2tt}><a href="https://mg.propo.fm/category/usecase/">Usecase</a></div>
