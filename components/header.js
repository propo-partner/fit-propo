          ...
          <div id="sp_nav" className={`${styles.sp_nav} ${styles.menu} ${styles.sp_size}` }>
					<ul className={styles.sp_nav__menu}>
						<li className={`${styles.sp_nav__menu__open} ${styles.drwBtn}`}>
							<div id="sp_drw_menu" className={styles.drwBtn__line}>
								<div></div>
								<div></div>
							</div>
							<p className={`${styles.font_en} ${styles.drwBtn__text}`}>
								<span className={styles.drwBtn__text__menu}>MENU</span>
								<span className={styles.drwBtn__text__close}>CLOSE</span>
							</p>
						</li>
					</ul>
				</div>
				<nav id="sp-drwNav" className={`${styles.drwNav} ${styles.sp_size}`}>
							...
							<div className={`${styles.drwNav__wrap__menu} ${styles.wide}`}>
								...
								<div className={styles.menuList}>
									<ul className={styles.menuList_category}>
										<li className={`${styles.menuList_categoryItem} ${styles.active}`}>
										...
										<li className={styles.menuList_categoryItem}>
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.72 107.72">
												<path className={styles.cls-1}
